...
public class IP {
    ...
    public IP(long ip_from, long ip_to, String[] country_code, String[] country_name, String[] region_name, String[] city_name, float latitude, float longitude, String[] zip_code, String[] time_zone) {
